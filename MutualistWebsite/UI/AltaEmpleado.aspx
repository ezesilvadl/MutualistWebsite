<%@ Page Title="Alta Empleado" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AltaEmpleado.aspx.cs" Inherits="AltaEmpleado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="form-container">
        <div class="auto-style1">Alta Empleado</div>
        <div class="form-group">
            <label for="txtNombreUsuario">Nombre Usuario:</label>
            <asp:TextBox ID="txtNombreUsuario" runat="server" Width="100%" />
        </div>
        <div class="form-group">
            <label for="txtContraseña">Contraseña:</label>
            <asp:TextBox ID="txtContraseña" runat="server" Width="100%" TextMode="Password" />
        </div>
        <div class="form-group">
